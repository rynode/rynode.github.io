...
function verifyLink(link) {
	...
	if (iframe) {
		...
		streamEl.classList.add("message");
		streamEl.innerHTML = iframe;

		$("#streams").appendChild(streamEl);
...
if (localStorageGet("allow-youtube") == "false") {
	$("#allow-youtube").checked = false;
	allowVideos = false;
}

$("#allow-youtube").onchange = function (e) {
	var enabled = !!e.target.checked;
	localStorageSet("allow-youtube", enabled);
	allowVideos = enabled;
};
